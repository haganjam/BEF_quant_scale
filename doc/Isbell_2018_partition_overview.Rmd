...
# set-up a function to explore thesee biodiversity effects under different assumptions
Isbell_explorer <- function(env, comp, n_runs, disp_rate, time_back) {
...
for (i in 1:n_runs) {
  ...
  x_out[[i]] <- x
  BEF_out[[i]] <- Isbell_2018_cleaner(mix = x$mixture, mono = x$monoculture, from_last  = time_back)
...
First, we simulate the case of pure spatial variation, neutral competition and no dispersal. In this case, we expect that all biodiversity effects would be due to spatial insurance. There is no local complementarity due to species interactions (neutral competition) and no mass effects because dispersal is zero.
...
Isbell_explorer(env = e.2, comp = si.2, n_runs = 10, disp_rate = 0, time_back = 5)
...
Isbell_explorer(env = e.2, comp = si.2, n_runs = 10, disp_rate = 0.05, time_back = 5)
...
Isbell_explorer(env = e.2, comp = si.1, n_runs = 10, disp_rate = 0.05, time_back = 5)
...
Isbell_explorer(env = e.3, comp = si.2, n_runs = 10, disp_rate = 0, time_back = 5)
...
Isbell_explorer(env = e.3, comp = si.1, n_runs = 10, disp_rate = 0.05, time_back = 5)
...
Isbell_explorer(env = e.1, comp = si.2, n_runs = 10, disp_rate = 0.05, time_back = 5)
